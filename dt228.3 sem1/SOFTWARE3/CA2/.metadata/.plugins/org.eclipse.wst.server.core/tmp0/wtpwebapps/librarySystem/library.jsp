        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="Library" items="${listBooks.rows}">
                <tr>
                 ...
                 <td> <form id = "formABC" action="FrontController" method="post">     
                    <input type="hidden" name="action" value="Borrow" />
                    <input type="hidden" name="borrowId" value="${Library.bookId}" />
                    <input type="hidden" name="bookStock" value="${Library.bookStock}" />
                    <input type="hidden" name="studentIn" value="${info}" />
                <input type="submit"  id="btnSubmit" value="Borrow"  />
                 </form> </td>
